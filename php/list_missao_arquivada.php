...
$cargo  = DBRead('missao', "WHERE status_missao = '1' ORDER BY datafin_missao");
?>
<?php include 'header.php' ?>
<h3 class="h3 text-center bg-primary text-light">Lista de Missões Cumpridas</h3>
<div class="row">
...
<div class="row">
    ...
    <table style="text-align: center;" class="table table-striped table-bordered col-6">
        ...
        <tbody>
            <?php if($cargo == false){ ?>
            <tr>
                <td colspan="7">Não existem missões cumpridas!</td>
            </tr>
...
<div class="row">
        <div class="col-3"><a href="list_missao.php"><img src="../_assets/_img/table_go.png"/> lista Missões</a></div>
        <div class="col-9"></div>
    </div>
</div>
<?php

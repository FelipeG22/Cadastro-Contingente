...
$trocar  = DBRead('servico', "INNER JOIN cw_tiposerv ON cw_servico.id_tiposerv = cw_tiposerv.id_tiposerv  WHERE cw_servico.status_servico = '2' ORDER BY cw_servico.data_servico, cw_servico.id_servico", "cw_servico.id_servico, cw_servico.nomeent_servico, cw_servico.nomesai_servico, cw_servico.data_servico, cw_tiposerv.tipo_servico, cw_servico.status_servico");

?>
    <?php include 'header.php' ?>
    <h3 class="h3 text-center bg-primary text-light">Lista de Trocas de Serviço Arquivadas</h3>
    <div class="row">
    ...
    <div class="row">
        ...
        <table style="text-align: center;" class="table table-striped table-bordered col-10">
            ...
            <tbody>
                <?php if($trocar == false){ ?>
                <tr>
                    <td colspan="7">Não existem trocas arquivadas!</td>
                </tr>
                <?php }else{ ?>
